...
namespace Elib2Ebook.DomainServices.Getters;
    ...
    private static HtmlDocument GetContent(EpubBook epubBook, EpubChapter epubChapter)
    {
        ...
        do
        {
            ...
            do
            {
                ...
                {
                    if (startNode.ParentNode == null || startNode.ParentNode.Name == "#document")
                    {
                        startNode = null;
                    }
                    else
