...
public class RenovelsChapter
{
    ...
    [JsonPropertyName("tome")] public int Tome { get; set; }

    [JsonPropertyName("content")] public string Content { get; set; }

    [JsonPropertyName("is_paid")] public bool IsPaid { get; set; }

    [JsonPropertyName("is_bought")] public bool? IsBought { get; set; }

    [JsonPropertyName("pages")] public JsonArray Pages { get; set; }
