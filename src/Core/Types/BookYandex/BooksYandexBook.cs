...
public abstract class BookmateBookBase
{
    ...
    [JsonPropertyName("cover")] public BooksYandexCover Cover { get; set; }

    [JsonPropertyName("title")] public string Title { get; set; }

    [JsonPropertyName("language")] public string Language { get; set; }

    [JsonPropertyName("linked_book_uuids")] public string[] LinkedBooks { get; set; }

    [JsonPropertyName("linked_audiobook_uuids")] public string[] LinkedAudio { get; set; }
...
{
    [JsonPropertyName("authors_objects")] public BooksYandexAuthor[] AuthorsObjects { get; set; }
...
{
    [JsonPropertyName("authors")] public BooksYandexAuthor[] Authors { get; set; }
