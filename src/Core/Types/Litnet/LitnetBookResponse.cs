...
public class LitnetBookResponse
{
    ...
    [JsonPropertyName("cycle_priority")] public int? CyclePriority { get; set; }

    [JsonPropertyName("adult_only")] public bool AdultOnly { get; set; }

    [JsonPropertyName("co_author_name")] public string CoAuthorName { get; set; }

    [JsonPropertyName("co_author")] public long? CoAuthorId { get; set; }
}
