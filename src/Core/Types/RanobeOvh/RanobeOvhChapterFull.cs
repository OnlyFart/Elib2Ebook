...
{
    [JsonPropertyName("pages")] public RanobeOvhPage[] Pages { get; set; }
...
public class RanobeOvhChapterShort
{
    ...
    [JsonPropertyName("number")] public decimal Number { get; set; }
...
public class RanobeOvhChapterContent
{
    ...
    [JsonPropertyName("marks")] public RanobeOvhChapterMark[] Marks { get; set; } = [];

    [JsonPropertyName("content")] public RanobeOvhChapterContent[] Content { get; set; } = [];
