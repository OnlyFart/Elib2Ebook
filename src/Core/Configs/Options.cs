...
public class Options
{
    ...
    [Option('l', "login", Required = false, HelpText = "Логин от системы")] public string Login { get; set; }

    [Option('p', "password", Required = false, HelpText = "Пароль от системы")] public string Password { get; set; }

    [Option("proxy", Required = false, HelpText = "Прокси в формате <host>:<port>")] public string Proxy { get; set; }

    [Option("flare", Required = false, HelpText = "Адрес flaresolverr")] public string Flare { get; set; }
    ...
    [Option("no-image", Required = false, HelpText = "Не загружать картинки")] public bool NoImage { get; set; }

    [Option("start", Required = false, HelpText = "Стартовый номер главы")] public int? Start { get; set; }

    [Option("end", Required = false, HelpText = "Конечный номер главы")] public int? End { get; set; }

    [Option("start-name", Required = false, HelpText = "Стартовое название главы")] public string StartName { get; set; }

    [Option("end-name", Required = false, HelpText = "Конечное название главы")] public string EndName { get; set; }
    ...
    public bool HasAdditionalType(AdditionalTypeEnum type)
        => Additional && (AdditionalTypes == null || !AdditionalTypes.Any() || AdditionalTypes.Contains(type));
