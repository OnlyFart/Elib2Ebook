...
using Elib2Ebook.ExternalServices.Bookstime.Types;
using HtmlAgilityPack;
using HtmlAgilityPack.CssSelectors.NetCore;
using Microsoft.Extensions.Logging;

namespace Elib2Ebook.ExternalServices.Bookstime;
...
public class BookstimeGetter(BookGetterConfig config) : GetterBase(config)
{
    ...
    public override async Task Authorize()
    {
        ...
        var response = await post.Content.ReadFromJsonAsync<AuthResponse>();
